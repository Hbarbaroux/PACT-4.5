...
public class UsersSQLiteHelper extends SQLiteOpenHelper {
    ...
    public static final String STATS_TABLE_CREATE = "CREATE TABLE " + STATS_TABLE_NAME + " (" + STATS_KEY + " INTEGER PRIMARY KEY AUTOINCREMENT, " + STATS_DATE + " TEXT, " + STATS_FICHIER + " TEXT, " + STATS_PROFILE + " INTEGER, CONSTRAINT " + FOREIGN_KEY + " FOREIGN KEY (" + STATS_PROFILE +") REFERENCES " + PROFILE_TABLE_NAME + "(" + PROFILE_KEY + "));";
